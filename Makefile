...
FILE_DA_CONSEGNARE=Makefile chatty.c message.h ops.h stats.h config.h \
		   ...
		   config.h connections.c icl_hash.c icl_hash.h lista.c lista.h \
		   listener.c chatterbox18.pdf README.txt README.doxygen \
		   scriptbash.sh testconf.sh testfile.sh testleaks.sh teststress.sh \
		   user_struct.c user_struct.h
# inserire il nome del tarball: es. NinoBixio
TARNAME=DomenicoProfumo
...
MAIL=domenico.profumo@gmail.com
#
###########################################################
...
#
###################################################################
UNIX_PATH       = /tmp/chatty_socket_533695
STAT_PATH       = /tmp/chatty_stats_533695.txt
DIR_PATH        = /tmp/chatty_533695
...
#client.o aggiunto solo per aumentare la dimensione del file 
